...
namespace PV__DS_y_RH___Proyecto_Gestor_de_Inventario.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public PedidoController(SQLServerContextGestionInventarioSJCP context)
        {
            _context = context;
        }
        ...
        {
            var sQLServerContextGestionInventarioSJCP = _context.Pedido.Include(p => p.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaPedido,Total,Estado,ClienteId")] Pedido pedido)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Cliente, "Id", "Apellido", pedido.ClienteId);
            return View(pedido);
        }
