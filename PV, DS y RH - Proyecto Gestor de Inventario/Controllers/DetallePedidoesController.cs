...
namespace PV__DS_y_RH___Proyecto_Gestor_de_Inventario.Controllers
{
    public class DetallePedidoesController : Controller
    {
        ...
        public DetallePedidoesController(SQLServerContextGestionInventarioSJCP context)
        {
            _context = context;
        }
        ...
        {
            var sQLServerContextGestionInventarioSJCP = _context.DetallePedido.Include(d => d.Pedido).Include(d => d.Producto);
        ...
        public async Task<IActionResult> Create([Bind("Id,PrecioOriginal,PrecioVendido,Obervacion,PedidoId,ProductoId")] DetallePedido detallePedido)
        {
            ...
            ViewData["ProductoId"] = new SelectList(_context.Set<Producto>(), "Id", "Nombre", detallePedido.ProductoId);
            return View(detallePedido);
        }
