...
namespace PV__DS_y_RH___Proyecto_Gestor_de_Inventario.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(SQLServerContextGestionInventarioSJCP context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Telefono,FechaRegistro")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
